...
public class frmResumenFlota extends javax.swing.JInternalFrame {
    ...
    public frmResumenFlota() {
        initComponents();
        mostrar(formatoFecha.format(frmConcentradoDetalleUnidades.txtFechaFinal.getDate()),formatoFecha.format(frmConcentradoDetalleUnidades.txtFechaFinal.getDate()));
    }
    
     void mostrar(String fechaInicio, String fechafinal){
         
         listaResumen.setModel(func.resumenUnidades(fechaInicio, fechafinal));
